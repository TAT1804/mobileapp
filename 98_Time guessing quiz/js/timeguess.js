...
stop.addEventListener("click",
  function () {
    ...
    console.log("time:", elapsed.toFixed(3), "second");
    if (elapsed >= 9.9 && elapsed <= 10.9) {
      soundStop2.currentTime = 0;
      soundStop2.play();
      document.body.classList.add("bg-fireworks");
...
reset.addEventListener("click",
  function () {
    document.body.classList.remove("bg-fireworks");
